...
class MyTableWidget(QWidget):
    ...
    def createFormGroupBox6(self):
        ...
        layout.addRow(QLabel(r'c<sub>A<\sub>, M'),self.input_widgets_dict6[5])
        layout.addRow(QLabel(r'c<sub>B<\sub>, M'),self.input_widgets_dict6[6])
        layout.addRow(QLabel(r'D<sub>A<\sub>, m<sup>2</sup> s<sup>-1</sup>'),self.input_widgets_dict6[7])
        layout.addRow(QLabel(r'D<sub>B<\sub>, m<sup>2</sup> s<sup>-1</sup>'),self.input_widgets_dict6[8])
        layout.addRow(QLabel(r'k<sub>0<\sub>'),self.input_widgets_dict6[9])
