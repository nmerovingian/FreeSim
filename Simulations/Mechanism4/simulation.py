...
def simulation_series(commands:tuple):
    index,variable1,variable2,variable3,variable4,variable5,variables6,kinetics,directory = commands

    for variable6 in variables6:
        simulation((index,variable1,variable2,variable3,variable4,variable5,variable6,kinetics,directory))



def simulation(commands:tuple)->None:
    variable1,variable2,variable3,variable4,variable5,variable6,kinetics,diffusion_mode,mechanism,directory = commands
    ...
    if mechanism == 4:
        Kf = variable2*dElectrode*dElectrode/Dref
        Kb = variable3*dElectrode*dElectrode/Dref
    elif mechanism ==3:
        Kf = variable2*dElectrode*dElectrode*cRef/Dref
        Kb = variable3*dElectrode*dElectrode/Dref
    elif mechanism == 5:
        Kf = variable2*dElectrode*dElectrode/Dref
        Kb = variable3*dElectrode*dElectrode/Dref
        ...
        Kf = variable2*dElectrode*dElectrode/Dref
        Kb = variable3*dElectrode*dElectrode*cRef/Dref
    else:
        raise ValueError
...
if __name__ == "__main__":
    simulation((0.005, 0.0, 0.0, 1e-08, 0.5, 0.0, 'BV', 'linear', './Irreversible'))
